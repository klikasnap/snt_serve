...
class CuRs:
    ...
    ) -> tuple[int, dict[str, bool | str | None], dict[str, str]]:
    ...
    def json(
        ...
        **kwargs,
        ...
        status_code, content, status = deepcopy(CuRs.rjson(
    ...
    ) -> Callable[[str, str], _TemplateResponse]:
        def inner(
...
CONSTANTS_YML = globals.CONSTANTS_YML = globals.CONSTANTS_YML
